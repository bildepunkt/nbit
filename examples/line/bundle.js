...
// Generated by CoffeeScript 1.9.3
(function() {
  var Bresenham, Line, Sprite, Vector, utils,
    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp = {}.hasOwnProperty;
    ...
    Line.prototype.render = function() {
      ...
      for (i = j = 0, len = ref.length; j < len; i = ++j) {
        ...
        if (nextPt != null) {
          ...
          Bresenham.calculate(point, nextPt, this._deps.viewport.drawPoint.bind(this._deps.viewport));
          ctx.restore();
        }
      }
      return void 0;
...
},{"./bresenham":2,"./lib/utils":6,"./sprite":9,"./vector":10}],8:[function(require,module,exports){
// Generated by CoffeeScript 1.9.3
(function() {
  var Base, Scene,
    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
...
},{"../../dist/collection":3,"../../dist/config":4,"../../dist/game":5,"../../dist/line":7,"../../dist/scene":8,"../../dist/viewport":11}]},{},[12]);
